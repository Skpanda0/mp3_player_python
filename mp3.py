...
default_image = Image.open(r"mp3_player_python\imgs\song.jpeg") 
default_image = default_image.resize((200, 200))
img = ImageTk.PhotoImage(image=default_image)
image_label.configure(image=img)
...
prev_img = tk.CTkImage(dark_image=Image.open(r'mp3_player_python\imgs\prev.png') , size=(25,25))
next_img = tk.CTkImage(dark_image=Image.open(r'mp3_player_python\imgs\next.png'), size=(25,25))
play_img = tk.CTkImage(dark_image=Image.open(r'mp3_player_python\imgs\play.png'), size=(25,25))
pause_img = tk.CTkImage(dark_image=Image.open(r'mp3_player_python\imgs\pause.png'), size=(25,25))
shuffle_img = tk.CTkImage(dark_image=Image.open(r'mp3_player_python\imgs\shuffle.png'), size=(25,25))
